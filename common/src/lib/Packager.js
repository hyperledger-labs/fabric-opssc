 ...
 *                 ['golang', 'node', 'java'] (default 'golang')
 ...
 */
module.exports.package = async function (chaincodePath, chaincodeType, metadataPath, goPath) {
	logger.debug('packager: chaincodePath: %s, chaincodeType: %s, metadataPath: %s',
		chaincodePath, chaincodeType, metadataPath);
