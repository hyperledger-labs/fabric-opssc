...
- Hyperledger Fabric v2.4.0 or later (Tested by using v2.4.4)
  - Also it works in v2.2.2 or later (Tested by using v2.2.6)
...
$ export FABRIC_VERSION=2.4.4
$ export FABRIC_CA_VERSION=1.5.4
