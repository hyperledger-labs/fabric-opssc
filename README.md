...
- Hyperledger Fabric v2.3.1 or later (Tested by using v2.3.2)
  - Also it works in v2.2.2 or later (Tested by using v2.2.3)
...
$ export FABRIC_VERSION=2.3.2
$ export FABRIC_CA_VERSION=1.5.1
